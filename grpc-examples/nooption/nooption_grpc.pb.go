...
func (c *greeterClient) SayHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error) {
	out := new(HelloReply)
	err := c.cc.Invoke(ctx, "/nooption.Greeter/SayHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (s *GreeterService) sayHello(_ interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     s,
		FullMethod: "/nooption.Greeter/SayHello",
	}
...
func RegisterGreeterService(s grpc.ServiceRegistrar, srv *GreeterService) {
	...
	sd := grpc.ServiceDesc{
		...
		Metadata: "examples/nooption/nooption.proto",
	}
