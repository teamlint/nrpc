...
// Package helloworld generated by protoc-gen-nrpc. sources: helloworld.proto
package helloworld
...
var (
	...
	serviceHETForGreeter = prometheus.NewSummaryVec(
		prometheus.SummaryOpts{
	...
	serviceRequestsForGreeter = prometheus.NewCounterVec(
		prometheus.CounterOpts{
...
func (h *GreeterHandler) MsgHandler(msg *nats.Msg) {
	...
	case "SayHello":
		...
		if err := nrpc.Unmarshal(request.Encoding, msg.Data, req); err != nil {
			...
			serviceRequestsForGreeter.WithLabelValues(
	...
	request.AfterReply = func(request *nrpc.Request, success, replySuccess bool) {
		...
		serviceHETForGreeter.WithLabelValues(request.MethodName).Observe(
...
func (c *GreeterClient) SayHello(req *HelloRequest) (*HelloReply, error) {
	...
	if err != nil {
		clientCallsForGreeter.WithLabelValues("SayHello", c.Encoding, "call_fail").Inc()
		return nil, err
	}
	// report total time taken to Prometheus
	elapsed := time.Since(start).Seconds()
	clientRCTForGreeter.WithLabelValues("SayHello").Observe(elapsed)
	clientCallsForGreeter.WithLabelValues("SayHello", c.Encoding, "success").Inc()
	return resp, nil
}
...
func init() {
	...
	prometheus.MustRegister(serviceHETForGreeter)
	prometheus.MustRegister(clientCallsForGreeter)
	prometheus.MustRegister(serviceRequestsForGreeter)
}
