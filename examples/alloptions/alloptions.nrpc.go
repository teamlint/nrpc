...
func (h *SvcCustomSubjectHandler) MsgHandler(msg *nats.Msg) {
	...
	case "mt_simple_reply":
		...
		if err := nrpc.Unmarshal(request.Encoding, msg.Data, req); err != nil {
			...
			request.Handler = func(ctx context.Context) (proto.Message, error) {
				...
				innerResp,
					err := h.service.MtSimpleReply(ctx, req)
				if err != nil {
					return nil, err
				}
	...
	case "mtvoidreqstreamedreply":
		...
		// var req github_com_teamlint_nrpc.Void
...
func (c *SvcCustomSubjectClient) MtNoRequestSubscribeSync() (*SvcCustomSubjectMtNoRequestSubscription, error) {
	...
	case "mtwithsubjectparams":
		...
		if err := nrpc.Unmarshal(request.Encoding, msg.Data, req); err != nil {
			...
			request.Handler = func(ctx context.Context) (proto.Message, error) {
				...
				innerResp,
					err := h.service.MtWithSubjectParams(ctx, mtParams[0], mtParams[1])
				if err != nil {
					return nil, err
				}
				return innerResp, nil
...
func (c *NoRequestServiceClient) MtNoRequestSubscribeSync() (*NoRequestServiceMtNoRequestSubscription, error) {
	subject := c.MtNoRequestSubject()
	natsSub, err := c.nc.SubscribeSync(subject)
	if err != nil {
		return nil, err
